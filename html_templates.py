"""
HTML templates for OpenSeadragon viewer
"""

def generate_openseadragon_html(dzi_file):
    """Generate HTML content for OpenSeadragon viewer with drawing functionality"""
...
def generate_error_html(error_message):
    """Generate HTML content for error display"""
    html_content = f'''<!doctype html>
<head>
    <title>Error - WSI Viewer</title>
    <style>
        body {{
            font-family: Arial, sans-serif;
            text-align: center;
